...
// 1. Capturamos el usuario de la URL o usamos 'cliente1' por defecto
$u_get = isset($_GET['u']) ? $_GET['u'] : 'cliente1';

// 2. Limpiamos el nombre para evitar caracteres raros (Seguridad)
$usuario_a_cargar = preg_replace('/[^a-zA-Z0-9_-]/', '', $u_get);
...
<head>
  ...
  <title>HSTD | <?php echo $config['nombre']; ?></title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #splash { position: fixed; inset: 0; z-index: 5000; display: flex; align-items: center; justify-content: center; flex-direction: column; text-align: center; transition: opacity 1s ease, visibility 1s; background: linear-gradient(rgba(255,255,255,.7), rgba(255,255,255,.7)), url(clientes/<?php echo $usuario_a_cargar; ?>/1.jpg?v=<?php echo time(); ?>) center/cover; }
    ...
    .hero-bg { position: absolute; inset: 0; background: url(clientes/<?php echo $usuario_a_cargar; ?>/10.jpg?v=<?php echo time(); ?>) center/cover; opacity: .6; }
...
<div class="gallery-grid">
    <?php for($i=2; $i<=9; $i++): ?>
        <img src="clientes/<?php echo $usuario_a_cargar; ?>/<?php echo $i; ?>.jpg?v=<?php echo time(); ?>" 
...
<section class="reveal" style="padding: 0 20px;">
    <div class="final-photo-container">
        <img src="clientes/<?php echo $usuario_a_cargar; ?>/11.jpg?v=<?php echo time(); ?>" alt="Final">
...
<audio id="audio" loop preload="auto">
  <source src="clientes/<?php echo $usuario_a_cargar; ?>/cancion1.mp3" type="audio/mpeg">
